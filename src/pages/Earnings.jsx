    ...
    <AdminLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          <div>
            <h1 className="text-3xl font-bold text-purple-900 dark:text-purple-50">Platform Earnings</h1>
            <p className="text-purple-600 dark:text-purple-300 mt-1">Revenue from all completed orders</p>
          </div>
          <select
            value={period}
        ...
        {topSellers.length > 0 && (
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg p-6">
            <h2 className="text-xl font-bold text-purple-900 dark:text-purple-50 mb-4 flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
              {topSellers.slice(0, 5).map((seller, idx) => (
                <div key={seller.sellerId} className="bg-purple-50 dark:bg-slate-700 rounded-lg p-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1 truncate">
                      <p className="font-semibold text-purple-900 dark:text-purple-50 text-sm truncate">{seller.shopName}</p>
                    </div>
                  </div>
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl shadow-lg overflow-hidden">
          <div className="p-6 border-b border-purple-200 dark:border-purple-700">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
              <h2 className="text-xl font-bold text-purple-900 dark:text-purple-50">Monthly Breakdown</h2>
              <div className="flex items-center gap-2 bg-purple-100 dark:bg-purple-900 rounded-full px-5 py-2 w-full md:w-80">
                <svg xmlns="http://www.w3.org/2000/svg" className="text-purple-600 dark:text-purple-300" width="20" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <input
                  ...
                  className="border-0 bg-transparent text-purple-900 dark:text-purple-50 outline-none w-full placeholder-purple-400"
                />
              </div>
            </div>
          </div>
              ...
              <tbody>
                {filteredEarnings.length === 0 ? (
                  ...
                  filteredEarnings.map((item, idx) => (
                    <tr key={idx} className="border-b border-purple-200 dark:border-purple-700 hover:bg-purple-50 dark:hover:bg-purple-900/20 transition-colors">
                      <td className="px-6 py-4 font-medium text-purple-900 dark:text-purple-50">{item.month}</td>
                      <td className="px-6 py-4 text-purple-700 dark:text-purple-300">{item.orders}</td>
                      <td className="px-6 py-4 text-purple-700 dark:text-purple-300 flex items-center">
          ...
          {/* Summary Footer */}
          <div className="p-4 bg-purple-50 dark:bg-slate-700 flex justify-between items-center">
            <span className="font-semibold text-purple-900 dark:text-purple-50">Total</span>
            <div className="flex items-center gap-8">
              <span className="text-purple-700 dark:text-purple-300">{totalOrders} orders</span>
              <span className="font-bold text-purple-900 dark:text-purple-50 flex items-center text-xl">
